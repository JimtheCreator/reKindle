...
public class LimitJournalAdapter extends RecyclerView.Adapter<LimitJournalAdapter.ViewHolder> {
    ...
    public LimitJournalAdapter(Context context, List<String> stringList, Activity activity) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        String habit = activity.getIntent().getStringExtra("title"); //TICK
...
//        String asubstring = hallostring.substring(0, 1);
        ...
        MiniJournalAdapter nestedRecyclerviewAdapter = new MiniJournalAdapter(journalList, holder.recyclerview.getContext());
...
//            month = itemView.findViewById(R.id.month);
    ...
    void displayJournals(String habit, String snapshot, MiniJournalAdapter homeEventAdapter, List<Journal> journalList) {
