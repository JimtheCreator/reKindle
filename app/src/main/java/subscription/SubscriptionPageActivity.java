...
//        tag = preference.getString("Price", "none");
        ...
        PaymentConfiguration.init(SubscriptionPageActivity.this, PUBLISH_KEY);
        ...
        monthly_button.setOnClickListener(v -> {
            fireball = "Monthly";
            yearly_button.setBackground(ContextCompat.getDrawable(SubscriptionPageActivity.this, R.drawable.fade_white));
            monthly_button.setBackground(ContextCompat.getDrawable(SubscriptionPageActivity.this, R.drawable.stateselected));
        });
        yearly_button.setOnClickListener(v -> {
            fireball = "Yearly";
            yearly_button.setBackground(ContextCompat.getDrawable(SubscriptionPageActivity.this, R.drawable.stateselected));
            monthly_button.setBackground(ContextCompat.getDrawable(SubscriptionPageActivity.this, R.drawable.fade_white));
        });
...
//        progressDialog.show();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(SubscriptionPageActivity.this);
